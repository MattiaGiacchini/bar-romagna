...
.ct4-title { margin: 0; color: var(--p-primary-500); font-size: clamp(1.75rem, 5vw, 3.25rem); }
.ct4-sub { margin: 0; font-size: 1rem; line-height: 1.6; color: var(--p-primary-500); max-width: 480px; }
.ct4-outline-btn {
